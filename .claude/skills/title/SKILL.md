...
Compose the title for the CURRENT thread right now and print it, and nothing else.
...
user), append its 8-hex prefix to the work slot in prose, as in `session 185a7b4e`.
